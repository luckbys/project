              ...
              <div className="container mx-auto px-6">
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
                        ...
                        {aboutMe?.contacts.email && (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">{aboutMe.contacts.email}</p>
                            </div>
                          </a>
                        )}
                        ...
                        {aboutMe?.contacts.whatsapp && (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">{aboutMe.contacts.whatsapp}</p>
                            </div>
                          </a>
                        )}
                        ...
                        {aboutMe?.contacts.github && (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">Projetos Open Source</p>
                            </div>
                          </a>
                        )}
                      </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -top-10 -right-10 w-72 h-72 bg-blue-50 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
                    <div className="absolute -bottom-10 -left-10 w-72 h-72 bg-indigo-50 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
                    ...
                    <div className="relative bg-white rounded-2xl shadow-lg p-8">
                      ...
                      <form onSubmit={handleSendMessage} className="space-y-6">
                        ...
                        <button
                          ...
                          className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-xl font-medium hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                        >
                          {sendingMessage ? (
                        ...
                        {messageSent && (
                          <div className="absolute bottom-4 left-4 right-4 bg-green-50 text-green-600 px-4 py-3 rounded-lg flex items-center gap-2 animate-fade-in-up">
